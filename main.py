...
if __name__ == '__main__':
    ...
    parser.add_argument('--replay_memory_size', type=int, default=1_000_00, help='Replay memory size')
    ...
    parser.add_argument('--final_exploration_frame', type=int, default=1_000_00, help='Final exploration frame')
